...
const Movies = () => {
  ...
  useEffect(() => {
    async function getGenres() {
      const resGenres = await axios.get("https://api.themoviedb.org/3/genre/movie/list?api_key=835d874e72bfa8309fafe5737461451b&language=tr-TR");
  ...
  useEffect(() => {
    async function getMovies() {
      let url = "";
      if (genreId) {
          url = `https://api.themoviedb.org/3/discover/movie?api_key=835d874e72bfa8309fafe5737461451b&with_genres=${genreId}&page=${currentPage}&language=tr-TR`;
      } else {
          url = `https://api.themoviedb.org/3/movie/popular?api_key=835d874e72bfa8309fafe5737461451b&page=${currentPage}&language=tr-TR`;
      }
